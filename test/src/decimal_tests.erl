...
rounding_test_() ->
    Tests =
        [
         ...
         {<<"-1.5">>, 0, round_floor, <<"-2">>},
         {<<"-1.9">>, 0, round_floor, <<"-2">>},
         {<<"0.002">>, 2, round_floor, <<"0">>},
         {<<"-0.002">>, 2, round_floor, <<"-1e-2">>},
         {<<"0.00001">>, 0, round_floor, <<"0">>},
         {<<"-0.00001">>, 0, round_floor, <<"-1">>},

         {<<"1">>, 1, round_cieling, <<"1">>},
         {<<"1.2">>, 1, round_cieling, <<"1.2">>},
         {<<"1.0">>, 0, round_cieling, <<"1">>},
         {<<"1.3">>, 0, round_cieling, <<"2">>},
         {<<"1.5">>, 0, round_cieling, <<"2">>},
         {<<"1.9">>, 0, round_cieling, <<"2">>},
         {<<"-1.0">>, 0, round_cieling, <<"-1">>},
         {<<"-1.3">>, 0, round_cieling, <<"-1">>},
         {<<"-1.5">>, 0, round_cieling, <<"-1">>},
         {<<"-1.9">>, 0, round_cieling, <<"-1">>},
         {<<"0.002">>, 2, round_cieling, <<"1e-2">>},
         {<<"-0.002">>, 2, round_cieling, <<"0">>},
         {<<"0.00001">>, 0, round_cieling, <<"1">>},
         {<<"-0.00001">>, 0, round_cieling, <<"0">>},
         ...
         {<<"1.0">>, 0, round_half_up, <<"1">>},
         {<<"1.3">>, 0, round_half_up, <<"1">>},
         {<<"1.5">>, 0, round_half_up, <<"2">>},
         {<<"1.9">>, 0, round_half_up, <<"2">>},
         {<<"-1.0">>, 0, round_half_up, <<"-1">>},
         {<<"-1.3">>, 0, round_half_up, <<"-1">>},
         {<<"-1.5">>, 0, round_half_up, <<"-1">>},
         {<<"-1.9">>, 0, round_half_up, <<"-2">>},
         {<<"0.002">>, 2, round_half_up, <<"0">>},
         {<<"-0.002">>, 2, round_half_up, <<"0">>},
         {<<"0.00001">>, 0, round_half_up, <<"0">>},
         {<<"-0.00001">>, 0, round_half_up, <<"0">>},

         {<<"1">>, 1, round_half_down, <<"1">>},
         {<<"1.2">>, 1, round_half_down, <<"1.2">>},
         {<<"1.0">>, 0, round_half_down, <<"1">>},
         {<<"1.3">>, 0, round_half_down, <<"1">>},
         {<<"1.5">>, 0, round_half_down, <<"1">>},
         {<<"1.9">>, 0, round_half_down, <<"2">>},
         {<<"-1.0">>, 0, round_half_down, <<"-1">>},
         {<<"-1.3">>, 0, round_half_down, <<"-1">>},
         {<<"-1.5">>, 0, round_half_down, <<"-2">>},
         {<<"-1.9">>, 0, round_half_down, <<"-2">>},
         {<<"0.002">>, 2, round_half_down, <<"0">>},
         {<<"-0.002">>, 2, round_half_down, <<"0">>},
         {<<"0.00001">>, 0, round_half_down, <<"0">>},
         {<<"-0.00001">>, 0, round_half_down, <<"0">>},
         ...
         {<<"-1.5">>, 0, round_down, <<"-1">>},
         {<<"-1.9">>, 0, round_down, <<"-1">>},
         {<<"0.002">>, 2, round_down, <<"0">>},
         {<<"-0.002">>, 2, round_down, <<"0">>},
         {<<"0.00001">>, 0, round_down, <<"0">>},
         {<<"-0.00001">>, 0, round_down, <<"0">>}
        ],
    [
